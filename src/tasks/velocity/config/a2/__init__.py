...
from .env_cfgs import (
  ...
  unitree_a2_transfer_rough_env_cfg,
)
...
register_mjlab_task(
  task_id="Unitree-A2-Transfer-Rough",
  env_cfg=unitree_a2_transfer_rough_env_cfg(),
  play_env_cfg=unitree_a2_transfer_rough_env_cfg(play=True),
  rl_cfg=unitree_a2_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
